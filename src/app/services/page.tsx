...
export const metadata: Metadata = buildMetadata({
  ...
  keywords: [
    ...
    "seo company vapi",
    "branding company vapi",
    "software company vapi",
    "AI solutions Vapi",
    "ecommerce development services Vapi",
    "custom web application development Vapi",
    "business automation services Gujarat",
    "CRM development services Vapi",
    "UI UX design services Vapi",
    "branding services Gujarat",
    "landing page design services Vapi",
    "portfolio website services Vapi",
    "Next.js development services India",
    "React development services Vapi",
    "full stack development services",
    "software development services Vapi",
    "digital transformation services Gujarat",
    "website maintenance services Vapi",
    "website revamp services Gujarat",
    "web hosting and domain services Vapi",
  ],
});
